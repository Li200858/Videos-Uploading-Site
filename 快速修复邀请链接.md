...
2. 找到您的服务（educational-video-platform）
3. 复制您的应用 URL，格式类似：`https://educational-video-platform-xxxx.onrender.com`
...
4. 设置值为您的完整应用 URL（例如：`https://educational-video-platform-xxxx.onrender.com`）
...
手动替换为：
```
https://your-app-name.onrender.com/login?email=xxx&token=xxx
```
...
```bash
# 在项目目录下运行
node scripts/create-test-invite.js <学生邮箱> <课程ID> https://your-app-name.onrender.com
```
